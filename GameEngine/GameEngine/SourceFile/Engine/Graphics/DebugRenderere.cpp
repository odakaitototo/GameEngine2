    ...
    for (auto& obj : app->m_gameObjects)
    {
        ...
        if (collider)
        {
            ...
            if (collider->GetColliderType() == ColliderType::AABB)
            {
                ...
                DirectX::XMMATRIX scaleMat = DirectX::XMMatrixScaling(box.Extents.x * 2.0f, box.Extents.y * 2.0f, box.Extents.z * 2.0f);
            ...
            {
                wireColor = DirectX::XMFLOAT4(1.0f, 1.0f, 0.0f, 1.0f); // 黄色
            }
